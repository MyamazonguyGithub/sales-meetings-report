...
from sheets.batched_one_offs.sheet_metrics_per_transcript import update_metrics_per_transcript_sheet
...
def main():
    ...
    # Report sheets
    dataframe_raw_data = gspread_try_get_worksheet_by_id(spreadsheet, 1793328857)
    meeting_sheets = (sheet_closed_won_meetings, sheet_closed_lost_meetings)
    sheet_df = update_metrics_per_transcript_sheet(meeting_sheets, dataframe_raw_data)
